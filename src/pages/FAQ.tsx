...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Процессинговая система — это цифровая платформа, обеспечивающая стабильную, безопасную и быструю обработку всех операций по приёму платежей. Такие платформы позволяют принимать оплату через различные каналы: банковские карты, рекуррентные списания, электронные кошельки. Сервисы вроде FinX позволяют подключить процессинг без глубоких технических знаний — достаточно стандартной интеграции через API или CMS-модуль."
    },
    {
